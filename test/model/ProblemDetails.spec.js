...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyLoanApiClient.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instane = new YlThirdPartyLoanApiClient.ProblemDetails();
      //expect(instance).to.be.a(YlThirdPartyLoanApiClient.ProblemDetails);
    });
